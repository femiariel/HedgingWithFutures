...
fut  = pd.read_excel(path, sheet_name="Futures")
...
res_pre  = estimate_mvhr_ols(df, start="2021-11-01", end="2022-02-23")
res_cris = estimate_mvhr_ols(df, start="2022-02-24", end="2022-03-15")
res_post = estimate_mvhr_ols(df, start="2022-03-16", end="2022-08-31")
...
pre_start, pre_end   = "2021-11-01", "2022-02-23"
cris_start, cris_end = "2022-02-24", "2022-03-15"
post_start, post_end = "2022-03-16", "2022-08-31"
